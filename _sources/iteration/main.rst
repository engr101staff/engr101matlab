...
Modify the code below to replace the update expressions in each of the loops with an equivalent using the shorthand operators above. The overall output of the program should not change.
