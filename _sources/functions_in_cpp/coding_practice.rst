...
.. tabbed:: functions_in_cpp_2
    ...
    .. tab:: Answer
        ...
        .. activecode:: functions_in_cpp_AC_2a
            :language: cpp
            :practice: T

            Below is one way to write the ``convertToBinary`` function. The function makes
            use of the ``if else`` structure to convert the decimal.
            ~~~~
            #include <iostream>
            using namespace std;
...
.. tabbed:: functions_in_cpp_4
    ...
    .. tab:: Answer
        ...
        .. activecode:: functions_in_cpp_AC_4a
            :language: cpp
            :practice: T 

            Below is one way to write the ``operate`` function. The function makes use of **if**, **else if**, and **else** statements
...
.. tabbed:: functions_in_cpp_6
    ...
    .. tab:: Answer
        ...
        .. activecode:: functions_in_cpp_AC_6a
            :language: cpp
            :practice: T 

            Below is one way to write the ``isCommonFactor`` function. The function makes use of the modulo operator
            and **if** statements.
            ~~~~
            #include <iostream> 
            using namespace std;
    ...
    .. tab:: Question
        ...
        .. activecode:: functions_in_cpp_AC_8q
            ...
            TEST_CASE("manDistance function") {
                REQUIRE(manDistance (0, 0, 3, 5) == 8);
                REQUIRE(manDistance (1, 2, 3, 4) == 4);
                REQUIRE(manDistance (-2, -4, 4, -2) == 8);
            }

    .. tab:: Answer

        .. activecode:: functions_in_cpp_8a
            :language: cpp
            :practice: T 

            Below is one way to write the ``manDistance`` function. The function makes use of the
            C++ ``abs`` function to find the absolute value of a number.
            ~~~~
            #include <iostream>
            using namespace std;
...
.. tabbed:: functions_in_cpp_10
    ...
    .. tab:: Question
        ...
        .. activecode:: functions_in_cpp_AC_10q
            ...
            would return 10. Run and test your code!
            ~~~~
            #include <iostream>
            using namespace std;
    ...
    .. tab:: Answer
        ...
        .. activecode:: functions_in_cpp_AC_10a
            :language: cpp
            :practice: t

            Below is one way to write the ``digitSum`` function. The function makes use
            of a while loop to iterate through all of the inputted number's digits.
            ~~~~
            #include <iostream>
            using namespace std;
